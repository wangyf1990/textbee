...
public class AppConstants {
    public static final String API_BASE_URL = "http://textbee.bitnova.dev/api/v1/";
    ...
    public static final String SHARED_PREFS_PROCESSED_SMS_IDS_KEY = "PROCESSED_SMS_IDS";
}
